...
app.on('ready', () => {
  ...
  if (process.argv.includes('--devmode')) mainWindow.openDevTools();

  // ... and load the html page generated by Webpack
  if (process.argv.includes('--devmode')) mainWindow.loadURL('http://localhost:4000/#library');
  else mainWindow.loadURL(`file://${distPath}/index.html#/library`);
